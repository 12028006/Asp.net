...
namespace DataBaseLayer
{
    ...
    public partial class MYDBEntities3 : ObjectContext
    {
        ...
        /// <summary>
        /// Initializes a new MYDBEntities3 object using the connection string found in the 'MYDBEntities3' section of the application configuration file.
        /// </summary>
        public MYDBEntities3() : base("name=MYDBEntities3", "MYDBEntities3")
        {
        ...
        /// <summary>
        /// Initialize a new MYDBEntities3 object.
        /// </summary>
        public MYDBEntities3(string connectionString) : base(connectionString, "MYDBEntities3")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new MYDBEntities3 object.
        /// </summary>
        public MYDBEntities3(EntityConnection connection) : base(connection, "MYDBEntities3")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
